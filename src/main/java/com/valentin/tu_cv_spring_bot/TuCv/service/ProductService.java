...
public interface ProductService {
    ...
    List<Product> getAllFiltered(String name, String category, String subCategory, String linea)
    ...
    List<Product> getAllPaged(int page, int size, String name, String category, String subCategory, String linea,
            String sortBy, String sortDir, boolean stockBajo) throws InvalidProductException;
    ...
    void batchUpdateFields(List<String> items, Double price, Double costPrice, Integer stock)
            throws InvalidProductException;

    void updateFields(String name, SubCategory subCategory, Double price, Double costPrice, Integer stock)
            throws InvalidProductException;
